...
public class GlobalizationCommand extends Plugin {
    ...
    /*
     * @Description: Returns the string identifier for the client's current
     * locale setting
     * 
    ...
    private JSONObject getLocaleName() throws GlobalizationError {
        JSONObject obj = new JSONObject();
        try {
            obj.put("value", Locale.getDefault().toString());// get the locale
                                                                // from the
                                                                // Android
                                                                // Device
            return obj;
    ...
    /*
     * @Description: Returns a date formatted as a string according to the
    ...
    private JSONObject getDateToString(JSONArray options) throws GlobalizationError {
        ...
        try {
            ...
            // get formatting pattern from android device (Will only have device
     ...
     * 
     * @Return: JSONObject Object.year {Number}: The four digit year
     * Object.month {Number}: The month from (0 - 11) Object.day {Number}: The
     * day from (1 - 31) Object.hour {Number}: The hour from (0 - 23)
     * Object.minute {Number}: The minute from (0 - 59) Object.second {Number}:
     * The second from (0 - 59) Object.millisecond {Number}: The milliseconds
     ...
     * @Return: JSONObject
     * 
     * Object.pattern {String}: The date and time pattern for formatting and
     * parsing dates. The patterns follow Unicode Technical Standard #35
     * http://unicode.org/reports/tr35/tr35-4.html Object.timezone {String}: The
     * abbreviated name of the time zone on the client Object.utc_offset
     * {Number}: The current difference in seconds between the client's time
     * zone and coordinated universal time. Object.dst_offset {Number}: The
     * current daylight saving time offset in seconds between the client's
     * non-daylight saving's time zone and the client's daylight saving's time
     * zone.
     * 
    ...
    private JSONObject getDatePattern(JSONArray options) throws GlobalizationError {
        ...
        try {
            SimpleDateFormat fmtDate = (SimpleDateFormat) android.text.format.DateFormat.getDateFormat((Context) this.ctx); // default
                                                                                                                    // user
                                                                                                                    // preference
                                                                                                                    // for
                                                                                                                    // date
            SimpleDateFormat fmtTime = (SimpleDateFormat) android.text.format.DateFormat.getTimeFormat((Context) this.ctx); // default
                                                                                                                    // user
                                                                                                                    // preference
                                                                                                                    // for
                                                                                                                    // time

            String fmt = fmtDate.toLocalizedPattern() + " " + fmtTime.toLocalizedPattern(); // default
                                                                                            // SHORT
                                                                                            // date/time
                                                                                            // format.
                                                                                            // ex.
            ...
            if (options.getJSONObject(0).length() > 1) {
                ...
                if (!((JSONObject) options.getJSONObject(0).get(Resources.OPTIONS)).isNull(Resources.FORMATLENGTH)) {
                    ...
                    if (fmtOpt.equalsIgnoreCase(Resources.MEDIUM)) {// medium
                        fmtDate = (SimpleDateFormat) android.text.format.DateFormat.getMediumDateFormat((Context) this.ctx);
                    } else if (fmtOpt.equalsIgnoreCase(Resources.LONG) || fmtOpt.equalsIgnoreCase(Resources.FULL)) { // long/full
                        fmtDate = (SimpleDateFormat) android.text.format.DateFormat.getLongDateFormat((Context) this.ctx);
                    }
                }
    ...
    /*
     * @Description: Returns an array of either the names of the months or days
     * of the week according to the client's user preferences and calendar
     * 
     * @Return: JSONObject Object.value {Array{String}}: The array of names
     * starting from either the first month in the year or the first day of the
     * week.
     * 
     * @throws: GlobalizationError.UNKNOWN_ERROR
     */
    private JSONObject getDateNames(JSONArray options) throws GlobalizationError {
        ...
        String[] list;
        try {
            SimpleDateFormat s = (SimpleDateFormat) android.text.format.DateFormat.getDateFormat((Context) this.ctx);
            ...
            if (method == 1) {
                list = ds.getShortMonths();
            }// months and narrow
            else if (method == 10) {
                list = ds.getWeekdays();
            }// days and wide
            else if (method == 11) {
                list = ds.getShortWeekdays();
            }// days and narrow
            else {
                list = ds.getMonths();
     ...
     * 
     * @Return: JSONObject Object.dst {Boolean}: The value "true" indicates that
     * daylight savings time is in effect for the given date and "false"
    ...
    /*
     * @Description: Returns the first day of the week according to the client's
     * user preferences and calendar. The days of the week are numbered starting
     * from 1 where 1 is considered to be Sunday.
     * 
    ...
    private JSONObject getFirstDayOfWeek(JSONArray options) throws GlobalizationError {
        JSONObject obj = new JSONObject();
        try {
            int value = Calendar.getInstance(Locale.getDefault()).getFirstDayOfWeek(); // get
                                                                                        // first
                                                                                        // day
                                                                                        // of
                                                                                        // week
    ...
    /*
     * @Description: Returns a number formatted as a string according to the
     * client's user preferences.
     * 
     * @Return: JSONObject Object.value {String}: The formatted number string.
     * 
     * @throws: GlobalizationError.FORMATTING_ERROR
     */
    private JSONObject getNumberToString(JSONArray options) throws GlobalizationError {
        ...
        String value = "";
        try {
            DecimalFormat fmt = getNumberFormatInstance(options);// returns
     ...
     * 
     * @Return: JSONObject Object.value {Number}: The parsed number.
     * 
     * @throws: GlobalizationError.PARSING_ERROR
     */
    ...
    /*
     * @Description: Returns a pattern string for formatting and parsing numbers
     * according to the client's user preferences.
     * 
     * @Return: JSONObject Object.pattern {String}: The number pattern for
     * formatting and parsing numbers. The patterns follow Unicode Technical
     * Standard #35. http://unicode.org/reports/tr35/tr35-4.html Object.symbol
     * {String}: The symbol to be used when formatting and parsing e.g., percent
     * or currency symbol. Object.fraction {Number}: The number of fractional
     * digits to use when parsing and formatting numbers. Object.rounding
     * {Number}: The rounding increment to use when parsing and formatting.
     * Object.positive {String}: The symbol to use for positive numbers when
     * parsing and formatting. Object.negative: {String}: The symbol to use for
     * negative numbers when parsing and formatting. Object.decimal: {String}:
     * The decimal symbol to use for parsing and formatting. Object.grouping:
     * {String}: The grouping symbol to use for parsing and formatting.
     * 
     * @throws: GlobalizationError.PATTERN_ERROR
     */
    private JSONObject getNumberPattern(JSONArray options) throws GlobalizationError {
        ...
        try {
            ...
            DecimalFormat fmt = (DecimalFormat) DecimalFormat.getInstance(Locale.getDefault()); // default
                                                                                                // format
     ...
     * currency code.
     * 
     * @Return: JSONObject Object.pattern {String}: The currency pattern for
     * formatting and parsing currency values. The patterns follow Unicode
     * Technical Standard #35 http://unicode.org/reports/tr35/tr35-4.html
     * Object.code {String}: The ISO 4217 currency code for the pattern.
     * Object.fraction {Number}: The number of fractional digits to use when
     * parsing and formatting currency. Object.rounding {Number}: The rounding
     * increment to use when parsing and formatting. Object.decimal: {String}:
     * The decimal symbol to use for parsing and formatting. Object.grouping:
     * {String}: The grouping symbol to use for parsing and formatting.
     * 
     * @throws: GlobalizationError.FORMATTING_ERROR
